...
// RequestOption is an option for the requests made by the Privy API API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/privy-api-client-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.privy.io/")
}
...
func WithEnvironmentStaging() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.staging.privy.io/")
}

// WithAppID returns a RequestOption that sets the client setting "appId".
func WithAppID(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.AppID = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Basic %s", base64.StdEncoding.EncodeToString([]byte(r.AppID+":"+r.AppSecret)))))
	})
}

// WithAppSecret returns a RequestOption that sets the client setting "appSecret".
func WithAppSecret(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.AppSecret = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Basic %s", base64.StdEncoding.EncodeToString([]byte(r.AppID+":"+r.AppSecret)))))
	})
