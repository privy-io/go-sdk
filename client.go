...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("PRIVY_APP_ID"); ok {
		defaults = append(defaults, option.WithAppID(o))
	}
...
// environment (PRIVY_APP_ID, PRIVY_APP_SECRET, PRIVY_API_BASE_URL). The option
