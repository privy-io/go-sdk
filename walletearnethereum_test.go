...
func TestWalletEarnEthereumClaimIncentiveWithOptionalParams(t *testing.T) {
	...
	_, err := client.Wallets.Earn.Ethereum.ClaimIncentive(
		context.TODO(),
		"wallet_id",
		privyclient.WalletEarnEthereumClaimIncentiveParams{
