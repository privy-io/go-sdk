...
func (r *WalletService) NewWalletsWithRecovery(ctx context.Context, body WalletNewWalletsWithRecoveryParams, opts ...option.RequestOption) (res *WalletNewWalletsWithRecoveryResponse, err error) {
	opts = slices.Concat(r.Options, opts)
...
type WalletNewWalletsWithRecoveryResponse struct {
	// The ID of the created user.
	RecoveryUserID string `json:"recovery_user_id,required"`
...
// Returns the unmodified JSON received from the API
func (r WalletNewWalletsWithRecoveryResponse) RawJSON() string { return r.JSON.raw }
func (r *WalletNewWalletsWithRecoveryResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//	case privyapiclient.EthereumPersonalSignRpcResponse:
//	case privyapiclient.EthereumSignTypedDataRpcResponse:
//	case privyapiclient.EthereumSignTransactionRpcResponse:
//	case privyapiclient.EthereumSendTransactionRpcResponse:
//	case privyapiclient.EthereumSignUserOperationRpcResponse:
//	case privyapiclient.EthereumSign7702AuthorizationRpcResponse:
//	case privyapiclient.EthereumSecp256k1SignRpcResponse:
//	case privyapiclient.SolanaSignMessageRpcResponse:
//	case privyapiclient.SolanaSignTransactionRpcResponse:
//	case privyapiclient.SolanaSignAndSendTransactionRpcResponse:
//	default:
...
type WalletNewWalletsWithRecoveryParams struct {
	PrimarySigner WalletNewWalletsWithRecoveryParamsPrimarySigner `json:"primary_signer,omitzero,required"`
	RecoveryUser  WalletNewWalletsWithRecoveryParamsRecoveryUser  `json:"recovery_user,omitzero,required"`
	Wallets       []WalletNewWalletsWithRecoveryParamsWallet      `json:"wallets,omitzero,required"`
	paramObj
}
...
type WalletNewWalletsWithRecoveryParamsPrimarySigner struct {
	...
	SubjectID string `json:"subject_id,required"`
	paramObj
}
...
type WalletNewWalletsWithRecoveryParamsRecoveryUser struct {
	LinkedAccounts []WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountUnion `json:"linked_accounts,omitzero,required"`
	paramObj
}
...
type WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountUnion struct {
	OfWalletNewWalletsWithRecoverysRecoveryUserLinkedAccountObject *WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountObject `json:",omitzero,inline"`
	OfVariant2                                                     *WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountObject `json:",omitzero,inline"`
	paramUnion
}

func (u WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountUnion) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfWalletNewWalletsWithRecoverysRecoveryUserLinkedAccountObject, u.OfVariant2)
}
func (u *WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountUnion) asAny() any {
	if !param.IsOmitted(u.OfWalletNewWalletsWithRecoverysRecoveryUserLinkedAccountObject) {
		return u.OfWalletNewWalletsWithRecoverysRecoveryUserLinkedAccountObject
...
// Returns a pointer to the underlying variant's property, if present.
func (u WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountUnion) GetAddress() *string {
	if vt := u.OfWalletNewWalletsWithRecoverysRecoveryUserLinkedAccountObject; vt != nil {
		return &vt.Address
	}
	return nil
}
...
// Returns a pointer to the underlying variant's property, if present.
func (u WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountUnion) GetCustomUserID() *string {
...
// Returns a pointer to the underlying variant's property, if present.
func (u WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountUnion) GetType() *string {
	if vt := u.OfWalletNewWalletsWithRecoverysRecoveryUserLinkedAccountObject; vt != nil {
...
type WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountObject struct {
...
func (r WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountObject) MarshalJSON() (data []byte, err error) {
	type shadow WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountObject
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountObject) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[WalletNewWalletsWithRecoveryParamsRecoveryUserLinkedAccountObject](
		"type", "email",
	)
}
